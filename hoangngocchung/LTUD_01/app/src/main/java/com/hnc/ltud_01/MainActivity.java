...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_edtUser = (EditText)findViewById(R.id.editUserName);
        m_edtPass = (EditText)findViewById(R.id.editPassword);
        m_btnLogin = (Button) findViewById(R.id.button_login);

        m_lblRegister = (TextView) findViewById(R.id.button_register);
    ...
    void apiLogin(String user, String pass) throws IOException {
        ...
        boolean bOk = (user.equals("hnchung") && pass.equals("123456"));
        if (bOk){
            _usernameLogined = "Hoang Ngoc Chung";
