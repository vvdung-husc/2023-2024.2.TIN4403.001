...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_edtUser = (EditText) findViewById(R.id.id_Name);
        m_edtPass = (EditText)findViewById(R.id.id_Pw);
        m_btnLogin = (Button) findViewById(R.id.Id_login);

        m_lblRegister = (TextView) findViewById(R.id.newUsId);
