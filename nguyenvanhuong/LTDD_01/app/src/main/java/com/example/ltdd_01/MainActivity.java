...
import com.example.ltdd_01.activity_register;
import com.example.ltdd_01.activity_user;
...
public class MainActivity extends AppCompatActivity {
    ...
    void apiLogin(String user, String pass) throws IOException {
        ...
        boolean bOk = (user.equals("nvhuong") && pass.equals("huong123"));
        if (bOk){
            Log.d("TIN4403", "Loi");
            _usernameLogined = "Nguyen van huong";
