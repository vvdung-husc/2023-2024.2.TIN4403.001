...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_edtUser = (EditText)findViewById(R.id.m_edtUser);
        m_edtPass = (EditText)findViewById(R.id.m_edtPass);
        m_edtRePass = (EditText)findViewById(R.id.m_edtRePass);
        m_edtName = (EditText)findViewById(R.id.m_edtName);
        m_edtEmail = (EditText)findViewById(R.id.m_edtEmail);
        m_btnRegister = (Button) findViewById(R.id.m_btnRegister);
