...
// login dat o day
public void Login(){
    String account = "Account    : " + User._username;
    String fullname = "Full name    : " + User._fullname;
    String email = "Email   : " + User._email;
    m_lblUser.setText(account);
    m_lblName.setText(fullname);
    m_lblEmail.setText(email);
...
public void AppData(){
        ...
        m_btnChange.setOnClickListener(v -> {
