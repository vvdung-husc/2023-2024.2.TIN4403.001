...
public class Changepass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_btnLogout = (Button) findViewById(R.id.btnBack);
        m_btnChange = (Button) findViewById(R.id.btnChange);

        m_lblWelcome.setText("---- WELCOME ----");

        m_lblUser.setText ("Username\t\t:\t" + User._username);
        m_lblName.setText ("Fullname\t\t:\t" + User._fullname);
        ...
        m_btnLogout.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), com.example.myapplicationhuy.MainActivity.class);
