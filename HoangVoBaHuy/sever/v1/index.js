...
app.get("/", function (req, res) {
  console.log(arrUser);
  res.status(200).send("Welcome to RESTFUL API - NODEJS - TIN4403 - HOANG VO BA HUY");
});
...
var arrUser = [];
var oUser = {};
oUser.username = "huyhoang24";
oUser.password = "12345678";
oUser.fullname = "Võ Việt ";
oUser.email = "huyhoang24@gmail.com";
